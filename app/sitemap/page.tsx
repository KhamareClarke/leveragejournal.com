...
import { BookOpen, Star, ArrowRight, User, LogOut, Clock, Shield, Map, ExternalLink } from 'lucide-react';
...
export default function Sitemap() {
  ...
  const sitePages = [
    {
      category: 'Main Pages',
      pages: [
        { name: 'Homepage', url: '/', description: 'Main landing page with 90-day transformation system overview' },
        { name: 'Features', url: '/features', description: 'Complete feature overview and detailed descriptions' },
        { name: 'How It Works', url: '/#how-it-works', description: '3-step transformation process explanation' },
        { name: 'Testimonials', url: '/#testimonials', description: 'Real user reviews and success stories' }
      ]
    },
    {
      ...
      pages: [
        ...
        { name: 'Help Center', url: '/support', description: 'Comprehensive support resources and guides' },
        { name: 'Shipping Info', url: '/shipping', description: 'Worldwide shipping information and process' }
      ]
    },
    {
      category: 'Account & User',
      pages: [
        { name: 'Sign In', url: '/auth/signin', description: 'User login and authentication' },
        { name: 'Sign Up', url: '/auth/signup', description: 'Create new user account' },
        { name: 'Dashboard', url: '/dashboard', description: 'User dashboard and progress tracking' }
      ]
    },
    {
      category: 'Legal & Policies',
      pages: [
        { name: 'Privacy Policy', url: '/privacy', description: 'How we protect and use your personal data' },
        { name: 'Terms of Service', url: '/terms', description: 'User agreement and terms of use' },
        { name: 'Returns & Refunds', url: '/returns', description: '30-day money-back guarantee and return process' }
      ]
    },
    {
      category: 'Site Information',
      pages: [
        { name: 'Sitemap', url: '/sitemap', description: 'Complete site navigation and page overview' },
  ...
  return (
    <>
      <head>
        <title>Sitemap - Leverage Journal™ | Complete Site Navigation</title>
        <meta name="description" content="Complete sitemap for Leverage Journal. Find all pages, features, support resources, and information about our 90-day transformation system." />
        <meta name="keywords" content="sitemap, site navigation, Leverage Journal, goal setting, transformation system" />
        <meta property="og:title" content="Sitemap - Leverage Journal™" />
        <meta property="og:description" content="Complete site navigation for our 90-day transformation system." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://leveragejournal.com/sitemap" />
      </head>
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="text-center space-y-4 mb-16">
              <div className="inline-flex items-center space-x-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full px-5 py-2 backdrop-blur-sm">
                ...
                <span className="text-yellow-200 text-sm font-medium">Site Navigation</span>
              </div>
              ...
              <p className="text-lg text-yellow-100 font-light">Complete Site Navigation</p>
              <p className="text-base text-gray-300 max-w-2xl mx-auto">
                Find all pages, features, and resources available on the Leverage Journal website. 
                Navigate easily to any section of our 90-day transformation system.
              </p>
            </div>
              ...
              {sitePages.map((category, categoryIndex) => (
                <div key={categoryIndex}>
                  <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
                    <span className="w-8 h-8 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center text-black font-bold text-sm mr-3">
                      {categoryIndex + 1}
                    </span>
                    {category.category}
                  </h2>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {category.pages.map((page, pageIndex) => (
                      <Card key={pageIndex} className="bg-black/50 border border-yellow-600/20 p-6 hover:border-yellow-400/40 hover:shadow-xl hover:shadow-yellow-500/10 transition-all duration-300 group rounded-2xl">
                        <div className="space-y-4">
                          <div className="flex items-start justify-between">
                            <h3 className="text-lg font-bold text-white group-hover:text-yellow-400 transition-colors">
                              {page.name}
                            </h3>
                            <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-yellow-400 transition-colors flex-shrink-0" />
                          </div>
            ...
            <div className="text-center mt-16">
              <Card className="bg-gradient-to-br from-yellow-600/10 via-yellow-500/5 to-transparent border border-yellow-600/20 p-8 rounded-2xl max-w-2xl mx-auto">
                <div className="space-y-4">
                  <h2 className="text-2xl font-bold text-white">For Search Engines</h2>
                  <p className="text-gray-300">
                    Looking for the machine-readable sitemap? Access our XML sitemap for search engine crawlers and SEO tools.
                  </p>
                  <a 
                    href="/sitemap.xml" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-2 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-black font-bold px-8 py-3 shadow-lg hover:scale-105 transition-all duration-300 rounded-xl"
                  >
