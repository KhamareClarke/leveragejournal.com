...
import { sendReviewRequests } from '@/lib/notifications/review-requests';
...
async function handler(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ error: error.message || 'Failed to send review requests' }, { status: 500 });
  }
}
